    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a class="logo">
          ...
          <span class="logo-mini"><b>VGA</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Ferreteria VGA</b></span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('deposito/articulo')}}"><i class="fa fa-circle-o"></i>Artículo</a></li>
            ...
            <li class="treeview">
              <a href="#">
                <i class="glyphicon glyphicon-piggy-bank"></i> <span>Pagos</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="{{url('pagos/corriente')}}"><i class="fa fa-circle-o"></i> Cta Corriente</a></li>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Administración VGA</h3>
